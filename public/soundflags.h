...
constexpr inline soundlevel_t ATTN_TO_SNDLVL( float a ) noexcept
{
	return (soundlevel_t)(int)(a > 0.0f ? (50 + 20 / a) : 0 );
}

template<typename T>
constexpr inline float SNDLVL_TO_ATTN( T a ) noexcept
{
	return a > 50 ? (20.0f / (float)(a - 50)) : 4.0F;
}
