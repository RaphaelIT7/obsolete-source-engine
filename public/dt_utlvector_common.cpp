...
// IF ONLY THERE WAS A WAY TO STATICALLY GENERATE THIS LOOKUP TABLE
COMPILE_TIME_ASSERT( ARRAYSIZE( s_DTElementNames ) == MAX_ARRAY_ELEMENTS );

const char *DT_ArrayElementNameForIdx( size_t i )
{
	Assert( i < MAX_ARRAY_ELEMENTS );
	return s_DTElementNames[i];
}
