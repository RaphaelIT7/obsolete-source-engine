...
public:
	...
	// A CThreadRWLock/CThreadSpinRWLock should perform better than a CThreadFastMutex
...
public:
	...
	FileHandle_t				FindFileInSearchPath( CFileOpenInfo &openInfo, bool bNative ); // Is normally a protected function.
